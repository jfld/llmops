...
from api.internal.schema.ai_schema import OptimizePromptReq, GenerateSuggestedQuestionsReq
from api.internal.service import AIService
from api.pkg.response import validate_error_json, compact_generate_response, success_json
