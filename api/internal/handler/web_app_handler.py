...
from api.internal.schema.web_app_schema import (
    WebAppChatReq,
    GetConversationsReq,
    GetConversationsResp,
)
from api.internal.service import WebAppService
from api.pkg.response import success_json, validate_error_json, success_message, compact_generate_response
